#!/bin/bash
#SBATCH --job-name=rl2_rel
#SBATCH --output=logs/const_rl2_ml10_relative_valid.txt
#SBATCH --ntasks=1
...
python3 constrained_rl2_ppo_metaworld_ml10.py --constraint_mode relative --epochs 20000
