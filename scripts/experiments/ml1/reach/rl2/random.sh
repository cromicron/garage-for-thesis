#!/bin/bash
#SBATCH --job-name=rl2_r_ra
#SBATCH --output=logs/const_rl2_ml1_reach_random.txt
#SBATCH --ntasks=1
...
python3 constrained_rl2_ppo_metaworld_ml1_template.py --env-name reach-v2 --constraint_mode random
