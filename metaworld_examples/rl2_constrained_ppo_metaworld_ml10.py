...
def rl2_ppo_metaworld_ml10(ctxt,
    ...
    """Train RL2 PPO with ML10 constrained environment.
    ...
    policy = GaussianGRUPolicy(
        ...
        weights_dir=f"saved_models/rl2_ml10_constrained/rl_2_gru.pth"
    )
    ...
    baseline = GaussianMLPValueFunction(
        ...
        load_weights=load_state,
        weights_dir=f"saved_models/rl2_ml10_constrained/baseline.pth"
        )
    ...
    if constraints:
        baseline_const = GammaMLPValueFunction(
            ...
            hidden_sizes=(32, 32),
            load_weights=False,
            weights_dir="saved_models/rl2_ml10_constrained/baseline_c.pth"
            )
    ...
    if w_and_b:
        wandb.init(project="rl2-ml10-constraint",
                   config={
